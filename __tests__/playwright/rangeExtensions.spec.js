...
test.describe("range/rangy extensions", () => {
  ...
  test("range.moveStart - move 1 character to the left", async ({ page }) => {
    await page.setContent(
      '<div id="el"><p>a paragraph</p><ol><li><span><img></span></li></ol></div>',
    );
  ...
  test("range.moveStart - move 15 characters to the left", async ({ page }) => {
    await page.setContent(
      '<div id="el"><p>test<span>a paragraph</span>test</p></div>',
    );
    const result = await page.evaluate(() => {
      const el = jQuery("#el");
      const changeEditor = getIce(el);
  ...
  test("range.moveStart - move 15 characters to the right", async ({
    page,
  }) => {
    await page.setContent(
      '<div id="el"><p>test<span>a paragraph</span>test</p></div>',
  ...
  test("range.moveStart - move 6 characters to the left (with em)", async ({
    page,
  }) => {
    await page.setContent(
      '<div id="el"><p>test<span><em>a paragraph</em></span>test</p></div>',
    );
    const result = await page.evaluate(() => {
      const el = jQuery("#el");
      const changeEditor = getIce(el);
  ...
  test("range.moveStart - move 19 characters to the right (with em)", async ({
    page,
  }) => {
    await page.setContent(
      '<div id="el"><p>test<span><em>a paragraph</em></span>test</p><p></p><p>test<span><em>a paragraph</em></span>test</p></div>',
    );
    const result = await page.evaluate(() => {
      const el = jQuery("#el");
      const changeEditor = getIce(el);
  ...
  test("range.moveStart - move 19 characters to the left (with em)", async ({
    page,
  }) => {
    await page.setContent(
      '<div id="el"><p>test<span><em>a paragraph</em></span>test</p><p></p><p>test<span><em>a paragraph</em></span>test</p></div>',
