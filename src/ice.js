  ...
  InlineChangeEditor.prototype = {
    ...
    initializeEnvironment: function () {
      ...
      this.env.window =
        ...
        this.env.document.parentWindow ||
        window;
    ...
    initializeRange: function () {
      ...
      range.setStart(
        ice.dom.find(this.element, this.blockEls.join(", "))[0],
        0,
      );
      range.collapse(true);
    ...
    placeholdDeletes: function () {
      ...
      ice.dom.each(
        ice.dom.find(this.element, deleteSelector),
        function (i, el) {
    ...
    _deleteLeft: function (range) {
      ...
      if (
        initialOffset === 0 ||
        commonAncestor.nodeType !== ice.dom.TEXT_NODE
      ) {
        ...
        if (moveLeft) {
          ...
          if (previousSibling) {
            const lastSelectable =
              range.getLastSelectableChild(previousSibling);
            if (lastSelectable) {
          ...
          let nextSibling = ice.dom.getNextContentNode(
            contentNode,
            this.element,
          );
          while (!found) {
            ...
            if (!ctNode) {
              ...
              nextSibling = ice.dom.getNextContentNode(
                nextSibling,
                this.element,
              );
            }
